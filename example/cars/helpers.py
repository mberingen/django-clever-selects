...
NAMES = {
    GENDER_MALE: [
        'Andrew', 'Arthur', 'Ian', 'Eric', 'Leonard', 'Lukas', 'Matt', 'Peter',
        'Vincent'
    ],
    GENDER_FEMALE: [
        'Allison', 'Angela', 'Catherine', 'Elisabeth', 'Evangeline', 'Heidi',
        'Katie', 'Lilly', 'Susan'
    ]
}
...
CONTINENTS = ((CONTINENT_NORTH_AMERICA,
               'North America'), (CONTINENT_SOUTH_AMERICA, 'South America'),
              (CONTINENT_EUROPE, 'Europe'), (CONTINENT_ASIA, 'Asia'),
              (CONTINENT_AFRICA,
               'Africa'), (CONTINENT_AUSTRALIA,
                           'Australia'), (CONTINENT_ANTARCTICA, 'Antarctica'))
...
COUNTRIES = {
    ...
    CONTINENT_SOUTH_AMERICA: [
        COUNTRY_COLOMBIA, COUNTRY_VENEZUELA, COUNTRY_BRAZIL, COUNTRY_CHILE,
        COUNTRY_URUGUAY, COUNTRY_ARGENTINA
    ],
    CONTINENT_EUROPE: [
        COUNTRY_SLOVAKIA, COUNTRY_SPAIN, COUNTRY_BULGARIA, COUNTRY_PORTUGAL,
        COUNTRY_ITALY, COUNTRY_UNITED_KINGDOM
    ],
    CONTINENT_ASIA:
    [COUNTRY_CHINA, COUNTRY_RUSSIA, COUNTRY_JAPAN, COUNTRY_INDIA],
    CONTINENT_AFRICA: [
        COUNTRY_ALGERIA, COUNTRY_EGYPT, COUNTRY_SUDAN, COUNTRY_ETHIOPIA,
        COUNTRY_SOMALIA, COUNTRY_MADAGASCAR
    ],
    CONTINENT_AUSTRALIA: [
        COUNTRY_WESTERN_AUSTRALIA, COUNTRY_NORTHERN_TERRITORY,
        COUNTRY_SOUTH_AUSTRALIA, COUNTRY_QUEENSLAND, COUNTRY_NEW_SOUTH_WALES,
        COUNTRY_VICTORIA, COUNTRY_TASMANIA,
        COUNTRY_AUSTRALIAN_CAPITAL_TERRITORY
    ],
    CONTINENT_ANTARCTICA: [
        COUNTRY_SOUTH_ORKNEY_ISLANDS, COUNTRY_GRAHAM_LAND,
        COUNTRY_MARIE_BYRD_LAND, COUNTRY_QEEN_MAUD_LAND, COUNTRY_VICTORIA_LAND,
        COUNTRY_WILKES_LAND
    ]
}
...
CITIES = {
    ...
    COUNTRY_CANADA: [
        'Ottawa', 'Edmonton', 'Victoria', 'Winnipeg', 'Halifax', 'Toronto',
    ...
    COUNTRY_MEXICO: [
        'Mexico City', 'Ecatepec', 'Guadalajara', 'Puebla', 'Leon', 'Juarez',
        'Tijuana'
    ],
    ...
    COUNTRY_URUGUAY: [
        'Montevideo', 'Salto', 'Ciudad de la Costa', 'Paysandu', 'Las Piedras',
        'Rivera', 'Maldonado'
    ],
    COUNTRY_ARGENTINA: [
    ...
    # Europe
    COUNTRY_SLOVAKIA: [
        'Bratislava', 'Kosice', 'Trebisov', 'Poprad', 'Zilina', 'Puchov',
        'Banska Bystrica', 'Presov'
    ],
    COUNTRY_SPAIN: [
    ...
    COUNTRY_PORTUGAL: [
        ...
        'Agualva-Cacem', 'Funchal'
    ],
    COUNTRY_ITALY: [
        'Rome', 'Milan', 'Naples', 'Turin', 'Palermo', 'Genoa', 'Bologna',
        'Florence', 'Bari', 'Catania', 'Venice'
    ],
    COUNTRY_UNITED_KINGDOM: [
        'London', 'Wells', 'Ripon', 'Truro', 'Ely', 'Chichester', 'Worcester',
        'Oxford'
    ],
    ...
    COUNTRY_RUSSIA: [
        ...
        'Nizhny Novgorod', 'Samara', 'Omsk', 'Kazan'
    ],
    COUNTRY_JAPAN: [
        'Tokyo', 'Aichi', 'Akita', 'Chiba', 'Fukui', 'Fukushima', 'Hokkaido',
        'Ishikawa', 'Kyoto', 'Osaka'
    ],
    COUNTRY_INDIA: [
    ...
    COUNTRY_SUDAN: [
        'Omdurman', 'Khartoum', 'Khartoum Bahri', 'Nyala', 'Port Sudan',
        'Kassala', 'Ubayyid', 'Kosti', 'Wad Madani'
    ],
    COUNTRY_ETHIOPIA: [
        'Addis Ababa', 'Dire Dawa', 'Mek\'ele', 'Adama', 'Gondar', 'Awasa',
        'Bahir Dar', 'Jimma', 'Dessie'
    ],
    COUNTRY_SOMALIA: [
    ...
    # Australia
    COUNTRY_WESTERN_AUSTRALIA: ['Perth', 'Bunbury'],
    COUNTRY_NORTHERN_TERRITORY: ['Darwin', 'Toowoomba'],
    COUNTRY_SOUTH_AUSTRALIA: ['Adelaide'],
    COUNTRY_QUEENSLAND:
    ...
    COUNTRY_TASMANIA: ['Hobart', 'Launceston'],
